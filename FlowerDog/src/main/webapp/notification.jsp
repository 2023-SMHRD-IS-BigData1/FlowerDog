                    ...
                    <div class="board__page">
                        <ul class="board__page-list">
                       	<li><a href="notification.jsp?page_num=1"><i class="fa-solid fa-angles-left"></i></a></li>
							...
							<li><a href="notification.jsp?page_num=<%=nowPage+1%>"><i class="fa-solid fa-angle-right"></i></a></li>	
							<%}else{ %>
							<li><a href="notification.jsp?page_num=<%=endPage%>"><i class="fa-solid fa-angle-right"></i></a></li>	
							<%} %>			
